...
const Header: React.FC = () => {
  ...
  return (
    <motion.header className="fixed top-0 left-0 right-0 z-50 py-4" style={{ backgroundColor: headerBackground }}>
  ...
  const orbs = useMemo(
    () =>
      [...Array(0)].map((_, i) => ({
        ...
        rgba(79, 70, 229, 0.3), 
        rgba(236, 72, 153, 0.3))`,
        x: [`${Math.random() * 15 - 7.5}%`, `${Math.random() * 15 - 7.5}%`, `${Math.random() * 15 - 7.5}%`],
        y: [`${Math.random() * 15 - 7.5}%`, `${Math.random() * 15 - 7.5}%`, `${Math.random() * 15 - 7.5}%`],
...
const DynamicBackground: React.FC = React.memo(() => {
  const particles = useMemo(() => [...Array(50)].map((_, i) => <Particle key={i} index={i} />), [])
  ...
  return (
    <section className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      >
        ...
        >
          From startups to enterprises, we help organizations accelerate their digital transformation by building,
          modernizing, and scaling apps that deliver results.
        </motion.p>
...
const ServiceCard: React.FC<{ title: string; subtitle: string; icon: React.ReactNode }> = React.memo(
  ({ title, subtitle, icon }) => {
    ...
    return (
      <motion.div
        className="bg-gradient-to-br from-black to-purple-900 p-6 rounded-lg shadow-xl transition-all duration-300 relative overflow-hidden"
      ...
      >
        ...
        <h3 className="text-xl font-bold mb-2 text-purple-200 relative z-10">{title}</h3>
        <p className="text-purple-300 relative z-10">{subtitle}</p>
        <motion.div
          className="absolute inset-0 bg-gradient-to-br from-purple-700 to-black opacity-0"
          initial={{ opacity: 0 }}
...
const EnhancedServicesSection: React.FC = () => {
  const services = useMemo(
    () => [
      ...
      },
      {
        ...
        subtitle: "Native iOS, Android, and cross-platform solutions for real-time chat, gaming, and collaboration.",
        icon: <Zap />,
      },
      {
      ...
      },
      {
        ...
        subtitle:
          "Leverage the power of artificial intelligence and machine learning to automate repetitive tasks and streamline processes.",
        icon: <Cpu />,
      },
    ],
    [],
  ...
  return (
    <section className="py-24 bg-black relative overflow-hidden">
      <motion.div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10" style={{ y }}>
        {/* Remove this line */}
        {/* <div className="absolute inset-0 bg-purple-900/10 blur-3xl -z-10"></div> */}
        <motion.div
        ...
        >
          ...
          <p className="text-xl text-purple-200 max-w-3xl mx-auto">
            Our team of experts works with you to build custom software that meets your unique business needs, from web
            and mobile apps to APIs and backend systems.
          </p>
        </motion.div>
    ...
    () => [
      {
        ...
        description: "As a boutique software house, we provide dedicated focus to each client",
        icon: <Users size={48} className="text-purple-400" />,
      },
      {
        title: "Agile Development",
        description: "Quick iterations and transparent communication",
        icon: <RefreshCw size={48} className="text-indigo-400" />,
      },
      {
        title: "Innovation-First",
        description: "Latest technologies and best practices",
        icon: <Lightbulb size={48} className="text-pink-400" />,
      },
      {
        title: "Cost-Effective",
        description: "Flexible solutions that grow with your business",
        icon: <Wallet size={48} className="text-blue-400" />,
      },
    ],
    [],
  )
      ...
      <motion.div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" style={{ y }}>
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          <motion.div
            ...
            viewport={{ once: true, amount: 0.3 }}
          >
            <h3 className="text-2xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-indigo-500 text-transparent bg-clip-text">
              Seven Edge Solutions
            </h3>
            <p className="text-gray-400">Building the future of business technology, one solution at a time.</p>
          </motion.div>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
